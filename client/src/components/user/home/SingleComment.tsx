...
const SingleComment:React.FC<singleCommentContainer> = ({comment,focusTextAreaReply})=>{
    ...
    return(
        <div>
            <div className="flex justify-center gap-2 p-2">
                <Link to={`/${comment?.commentedUser}`} className="w-10 h-10 p-1">
                ...
                <div className="flex flex-col">
                    <div className="flex flex-col justify-center rounded bg-blue-gray-100 p-1">
                        <Link to={`/${comment?.commentedUser}`} className="text-black font-body" >{comment?.commentedUser}</Link>
