                                ...
                                <div className="flex justify-center items-center gap-2 m-2">
                                    ...
                                    <div className="ml-auto mr-auto flex justify-center items-center w-1/2 h-1/2 p-2">
                                        <div className="rounded-full overflow-hidden">
                                            <img className="object-cover" src={profilePhoto ? (URL.createObjectURL(profilePhoto)) : (profileImg?.length) ? (CLOUDINARY_PROFILE_PHOTO_URL + profileImg) : PROFILE_PHOTO} alt='Profile photo' />
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="file-label break-words">Allowed formats: JPG, JPEG, PNG</p>
                                    </div>
                                </div>

                                <div className="text-center p-2 space-x-4">
                                    <Button onClick={handleOpenImg} size="lg" className="px-2 py-1 mt-2 capitalize font-thin">Cancel</Button>

                                    <Button onClick={submitProfilePhoto} disabled={submitState} size="lg" className="px-2 py-1 mt-2 capitalize font-thin">Update</Button>
                                </div>
