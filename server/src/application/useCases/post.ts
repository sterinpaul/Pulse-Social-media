...
export const postReport = async(userName:string,postId:string,postRepository:ReturnType<postDbInterface>)=>{
    return await postRepository.reportThePost(userName,postId)
}